---
title: Masonry Feed
description: A Pinterest-style image feed that places images left to right into the shortest column using manual height calculation.
image: /og/components/masonry-feed
category: components
