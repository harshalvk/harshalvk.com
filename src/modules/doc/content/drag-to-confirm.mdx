...
description: A slider the user must drag all the way to the right to confirm a destructive or irreversible action — safer than a confirm dialog.
image: /og/components/drag-to-confirm
category: components
